...
const Home = () => {
    ...
    const icons = {
        ...
        submitReport: "M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11z", // Document
            ...
            <main className="home-main-content">
                ...
                <section className="quick-actions">
                    ...
                    <div className="quick-actions-grid">
                        ...
                        <Link to="/review-submissions" className="action-card">
                    ...
                    <div className="left-column">
                        <div className="card schedule-card">
                            <div className="card-header">
                                ...
                                <span className="date-text-header">Wednesday, 24 Jan</span>
                            </div>

                            <div className="schedule-item active">
                                <div className="time-slot">
                                    <span>08:00</span>
                                    <span style={{ fontSize: '0.9rem' }}>AM</span>
                                </div>
                            ...
                            <div className="schedule-item">
                                <div className="time-slot">
                                    <span>01:30</span>
                                    <span style={{ fontSize: '0.9rem' }}>PM</span>
                                </div>
                                <div className="class-info">
                        ...
                        <div className="card">
                            ...
                            <div className="task-list">
                                <div className="task-item">
                                    ...
                                    <div className="task-due" style={{ color: '#ef4444' }}>Due Today</div>
                                </div>
                                <div className="task-item">
